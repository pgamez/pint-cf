...
pint-cf's unit-definition data
(`src/pint_cf/resources/registry/udunits2*.txt`) is generated from
[UDUNITS-2](https://www.unidata.ucar.edu/software/udunits/)'s own XML
